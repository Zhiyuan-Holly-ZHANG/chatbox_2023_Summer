...
function getHotelCode() {
    ...
    site_cd1 = split_url[3];
    site_cd = split_url[4];
    
    if (document.getElementById("Hotel_id")) hotel_id = document.getElementById("Hotel_id").value;
    if (document.getElementById("hotel_id")) hotel_id = document.getElementById("hotel_id").value;
    if (document.getElementById("HotelID")) hotel_id = document.getElementById("HotelID").value;
    if (document.getElementById("hotel")) { hotel_number = document.getElementById("hotel").value; }
    else { hotel_number = getQuerystring("hotel", false); }
    if (hotel_id == "undefined")
        hotel_id = "";
    if (hotel_number == "undefined")
        hotel_number = "";

    hotel_cd = getQuerystring("hotel_id", false);
    if (!hotel_cd) hotel_cd = getQuerystring("Hotel_id", false);

    var hotel_name = getQuerystring("hotelname", false);
    if (!hotel_name) hotel_name = getQuerystring("hotelName", false);
    if (!hotel_name) hotel_name = getQuerystring("HotelName", false);
    
    var isCorp = (site_cd1 != "8degrees" && site_cd1 != "metropolis" && site_cd1 != "northpoint" && 
                site_cd1 != "resortcity" && site_cd1 != "chongqing" && site_cd1 != "kowloon" &&
                site_cd1 != "garden" && site_cd1 != "oasis" && site_cd1 != "hong-kong"&& 
                site_cd1 != "kowloonharbourfront");
    
    try {
        if (domain_name == "www.harbour-plaza.com" || domain_name == "book.harbour-plaza.com") {
            if (!hotel_cd && !hotel_number && !hotel_id && isCorp) { // no hotel id and no hotel number
                account_code = "hphplaza-corporate";
            }
            else {
	  if (site_cd1 == "group" || site_cd == "group" || hotel_cd == "group") account_code = "hphplaza-corporate";
                if (site_cd1 == "8degrees" || site_cd == "8degrees" || hotel_cd == "hp8d" || hotel_number == "12" || hotel_id == "12") account_code = "hph8degrees";
                if (site_cd1 == "metropolis" || site_cd == "metropolis" || hotel_cd == "hpme" || hotel_number == "8" || hotel_id == "8") account_code = "hphmetropolis";
                if (site_cd1 == "northpoint" || site_cd == "northpoint" || hotel_cd == "hpnp" || hotel_number == "3 " || hotel_id == "3") account_code = "hphnorthpoint";
                if (site_cd1 == "resortcity" || site_cd == "resortcity" || hotel_cd == "hprc" || hotel_number == "2" || hotel_id == "2") account_code = "hphresortcity";
                if (site_cd1 == "kowloonhotel" || site_cd == "kowloonhotel" || hotel_cd == "klnh" || hotel_number == "9" || hotel_id == "9") account_code = "hphkowloonhotel";
                if (site_cd1 == "kowloonharbourfront" || site_cd == "kowloonharbourfront" || hotel_cd == "khfh" || hotel_number == "13" || hotel_id == "13") account_code = "hphkowloonharbourfront";
            }

        } else if (domain_name == "www.ramblerhotels.com" || domain_name == "book.ramblerhotels.com") {
            if (!hotel_cd && !hotel_number && !hotel_id && isCorp) {
                account_code = "hphrambler-corporate";
            }
            else {
                if (site_cd1 == "garden" || site_cd == "garden" || hotel_cd == "hrgh" || hotel_number == "10" || hotel_id == "10") account_code = "hphrambler-garden";
                if (site_cd1 == "oasis" || site_cd == "oasis" || hotel_cd == "hroh" || hotel_number == "11" || hotel_id == "11") account_code = "hphrambler-oasis";
            }
        } else if (domain_name=="www.harbour-grand.com" || domain_name=="www.harbourgrand.com" || domain_name=="book.harbourgrand.com" || domain_name=="hongkong.harbourgrand.com" || domain_name=="kowloon.harbourgrand.com") {
            if (!hotel_cd && !hotel_number && !hotel_id && isCorp) {
                account_code = "hphgrand-corporate";
            }
            else {
                if (site_cd1=="kowloon"   || site_cd=="kowloon"   || hotel_cd=="hgkl" || hotel_number=="63" || hotel_id=="63") account_code="hphgrandkowloon";
	            if (site_cd1=="hongkong" || site_cd=="hongkong" || hotel_cd=="hghk" || hotel_number=="60" || hotel_id=="60") account_code ="hphgrandhk";

            }
        } else if (domain_name == "m.harbour-plaza.com") {
	        if (!hotel_name && isCorp) {
                account_code = "hphplaza-corporate-mobile";
            }
            else {

                if (hotel_name == "8degrees" || site_cd1 == "8degrees") account_code = "hph8degrees-mobile";
                if (hotel_name == "metropolis" || site_cd1 == "metropolis") account_code = "hphmetropolis-mobile";
                if (hotel_name == "northpoint" || site_cd1 == "northpoint") account_code = "hphnorthpoint-mobile";
                if (hotel_name == "kowloonhotel" || site_cd1 == "kowloonhotel") account_code = "hphkowloonhotel-mobile";
                if (hotel_name == "resortcity" || site_cd1 == "resortcity") account_code = "hphresortcity-mobile";
                if (hotel_name == "kowloonharbourfront" || hotel_name == "kowloonharbourfront" || site_cd1 == "kowloonharbourfront" || site_cd1 == "KowloonHarbourfront") account_code = "hphkowloonharbourfront-mobile";
            }
        } else if (domain_name == "m.ramblerhotels.com") {
            if (!hotel_name && isCorp) {
                account_code = "hphramblerhotels-mobile";
            }
            else {
                if (hotel_name == "garden" || site_cd1 == "garden") account_code = "hphrambler-garden-mobile";
                if (hotel_name == "oasis" || site_cd1 == "oasis") account_code = "hphrambler-oasis-mobile";
            }
        }
    } catch (e) {
        account_code = "hphtest-dev";
    }
    if (!account_code) account_code = "hphtest-dev";
    return account_code;
}

function getCurrencyCode(hotel_code) {
    if (hotel_code == "hphchongqing") { return "RMB"; }
    else if (hotel_code == "hphourlucaya-corporate") { return "USD"; }
    return "HKD";
}

var s_account=getHotelCode()+",hphglobal-test";  //report suite ID 
...
s.charSet="UTF-8";
/* Conversion Config */
s.currencyCode=getCurrencyCode(s_account);
/* Link Tracking Config */
s.trackDownloadLinks=true
s.trackExternalLinks=true
s.trackInlineStats=true
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
s.linkInternalFilters="javascript:,harbour-plaza.com,harbour-grand.com,ramblerhotels.com,ourlucaya.com,harbourgrand.com"
...
/* Plugin :  timeparting */
s.prop12=s.getTimeParting('d','+8'); // 
s.eVar17=s.prop12;

/* External Campaign Tracking Code Detection */
if(!s.campaign) s.campaign=s.getQueryParam('cid')

/* Get Page Name from URL */
	s_pn=s.getPageName();
	s_lang=s.channelExtract(":",1,s_pn); s.eVar21 = s_lang.substring(0,s_lang.length-1);
	s_fn=s_pn.substring(s_pn.indexOf(":")+1,s_pn.length);
	s_pn=s_lang;
		if (s.getQueryParam('hotel_id')) { s_pn=s_pn+s.getQueryParam('hotel_id')+":"; s.eVar22=s.getQueryParam('hotel_id');}
		if (s.getQueryParam('section_id')) { s_pn=s_pn+s.getQueryParam('section_id')+":"; s.channel=s.getQueryParam('section_id');}
		if (s.getQueryParam('subsection_id')) { s_pn=s_pn+s.getQueryParam('subsection_id')+":"; }
		if (s.getQueryParam('record_id')) { s_pn=s_pn+s.getQueryParam('record_id')+":"; }
		if (s.getQueryParam('fac_id')) { s_pn=s_pn+s.getQueryParam('fac_id')+":"; }
		if (s.getQueryParam('fm_date')) { s_pn=s_pn+s.getQueryParam('fm_date')+":"; s.eVar13=s.getQueryParam('fm_date');}
		if (s.getQueryParam('to_date')) { s_pn=s_pn+s.getQueryParam('to_date')+":"; s.eVar14=s.getQueryParam('to_date');}
		if (s.getQueryParam('GuestNo')) { s_pn=s_pn+s.getQueryParam('GuestNo')+":"; s.eVar6=s.getQueryParam('GuestNo');}
		if (s.getQueryParam('RoomNo')) { s_pn=s_pn+s.getQueryParam('RoomNo')+":"; s.eVar3=s.getQueryParam('RoomNo');}

	s_pn=s_pn+s_fn;
	if (!s.pageName) s.pageName=s_pn;

/* Copy props to eVars */
if(s.prop1) s.eVar1=s.prop1; 		// Site Section
...
s.visitorNamespace="harbourplazahotel"
s.dc="122"
